  ...
  return (
    <>
      <button
        ...
        className="relative group overflow-hidden bg-gradient-to-br from-indigo-500 to-indigo-700 hover:from-indigo-600 hover:to-indigo-800 
          text-white font-bold px-5 py-3 rounded-lg flex items-center transform transition-all duration-200 
          border border-indigo-400 shadow-[0_8px_0_rgb(79,70,229),0_15px_20px_rgba(0,0,0,0.3)]
          hover:shadow-[0_4px_0_rgb(79,70,229),0_8px_15px_rgba(0,0,0,0.3)]
          active:translate-y-4 active:shadow-[0_0px_0_rgb(79,70,229),0_0px_10px_rgba(0,0,0,0.2)]"
      >
        ...
        <Users className="h-5 w-5 mr-2 drop-shadow-lg" />
        <span>Guarnição</span>
      </button>
