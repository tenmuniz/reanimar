        ...
        <div className="mt-8 bg-white rounded-xl shadow-lg border border-gray-200 p-6 animate-fade-in-down">
          ...
          <div className="relative mb-4">
            <input
              ...
              className="w-full px-4 py-2 bg-white text-gray-900 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 pl-10 font-medium shadow-sm"
            ...
            {filtroMilitar && (
              <button
                onClick={() => setFiltroMilitar('')}
                className="absolute right-3 top-2.5 text-gray-400 hover:text-gray-600 rounded-full p-1 hover:bg-gray-100"
