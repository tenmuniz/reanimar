          ...
          <div className="flex flex-wrap justify-between items-center">
            ...
            <div className="relative z-10 bg-white/10 p-4 rounded-2xl backdrop-blur-md shadow-lg border border-white/20 max-w-2xl">
              <div className="flex items-center justify-between">
                <div className="inline-flex items-center mb-1 bg-blue-700/30 px-2 py-0.5 rounded-full">
                  <span className="w-2 h-2 bg-blue-400 rounded-full animate-pulse mr-1.5"></span>
                  <span className="text-xs text-blue-100 font-medium tracking-wide">SISTEMA OPERACIONAL</span>
                </div>
              </div>
              
              <div className="flex flex-col items-start">
                <h1 className="text-4xl font-extrabold text-blue-100 leading-tight mb-0">POLÍCIA MAIS FORTE</h1>
                <div className="flex items-center">
                  <span className="text-yellow-400 mr-1.5">•</span>
                  <span className="text-xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-blue-300 via-blue-100 to-indigo-200">Extraordinário</span>
                </div>
              </div>
            </div>
