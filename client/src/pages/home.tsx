  ...
  return (
    <div className="min-h-screen font-sans">
      ...
      <main className="container mx-auto px-4 mb-8">
        {/* Apresentação e links das operações */}
        <div className="p-6 mb-8 bg-white bg-opacity-5 backdrop-filter backdrop-blur-lg rounded-2xl shadow-lg border border-white/10">
          <h2 className="text-2xl font-bold mb-4 text-blue-100">SISTEMA DE GESTÃO DE EXTRAS</h2>
          ...
          <div className="flex flex-wrap gap-4">
            <a href="/" className="bg-blue-700 hover:bg-blue-600 text-white px-6 py-3 rounded-lg flex items-center shadow-lg transition-all duration-300">
              <div className="mr-3 p-2 bg-blue-600 rounded-lg">
                <Shield className="h-5 w-5" />
              </div>
              <div>
                <div className="font-bold">Polícia Mais Forte</div>
                <div className="text-xs text-blue-200">Gestão de extras PMF</div>
              </div>
            </a>
            
            <a href="/escola-segura" className="bg-purple-700 hover:bg-purple-600 text-white px-6 py-3 rounded-lg flex items-center shadow-lg transition-all duration-300">
              <div className="mr-3 p-2 bg-purple-600 rounded-lg">
                <BookOpen className="h-5 w-5" />
              </div>
              <div>
                <div className="font-bold">Escola Segura</div>
                <div className="text-xs text-purple-200">Proteção escolar</div>
              </div>
            </a>
          </div>
        </div>
